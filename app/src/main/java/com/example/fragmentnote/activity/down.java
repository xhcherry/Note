...
import com.example.fragmentnote.adapter.NoteAdapter;
import com.example.fragmentnote.services.DownloadBinder;
import com.example.fragmentnote.services.DownloadListener;
import com.example.fragmentnote.services.DownloadServices;
...
public class down extends BaseActivity implements View.OnClickListener {
    ...
    public void onClick(View view) {
        Intent intent = new Intent(down.this, DownloadServices.class);
        intent.putExtra("url", "https://dldir1.qq.com/qqfile/qq/PCQQ9.6.9/QQ9.6.9.28878.exe");
        switch (view.getId()) {
            case R.id.start_btn:
                down.this.bindService(intent, new ServiceConnection() {
                    @Override
